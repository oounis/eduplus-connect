...
> = {
  ...
  periods: {
    label: "School day",
    description: "The periods of the school day, applied to every day",
    href: "/periods",
    icon: "calendar",
  },
  periodAttendance: {
    label: "Attendance by period",
    description: "Teachers mark their class for the period running now",
    href: "/period-attendance",
    icon: "check",
  },
  observations: {
    label: "Observations",
  ...
  periodReports: {
    ...
    description: "Attendance by period, day and class — exportable to Excel",
    href: "/period-reports",
    icon: "chart",
  },
  audit: {
...
> = {
  ADMIN: {
    ...
    periods: { view: true, edit: true },
    // Edit, so a mistake can still be corrected after the period has closed.
    periodAttendance: { view: true, edit: true },
    observations: { view: true, edit: false },
    tasks: { view: true, edit: true },
    reports: { view: true, edit: false },
    periodReports: { view: true, edit: false },
  ...
  STAFF: {
    ...
    attendance: { view: true, edit: false },
    periods: { view: true, edit: false },
    periodAttendance: { view: true, edit: false },
    observations: { view: true, edit: false },
